...
<head>
    ...
    <meta property="og:title" content="Schools &amp; Divisions | Johns Hopkins University">
    <meta property="og:url" content="index.html">
    <meta property="og:description" content="Johns Hopkins University enrolls more than 21,000 full-time and part-time students at its nine academic divisions, eight of which are based in Baltimore">
    <meta property="og:image" content="../assets/uploads/2015/03/carey_lobby-1600x800.jpg">
    <meta property="og:image:url" content="../assets/uploads/2015/03/carey_lobby-1600x800.jpg">
    ...
    <link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed21eb.json?url=https%3A%2F%2Fwww.jhu.edu%2Fschools%2F">
    <link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed2f40?url=https%3A%2F%2Fwww.jhu.edu%2Fschools%2F&amp;format=xml">
    <script>
                    ...
                    <ul class="site-tree tier-1">
                        ...
                        <li class="parent-level"> <a href="#" class="toggle-section" title="Expand Academics section"><i class="fa fa-plus-square-o" aria-hidden="true"></i><span class="icon-fallback">+</span><span class="visuallyhidden">Expandir o menu Linhas de pesquisa</span></a> <a href="{{url('/linhasdepesquisa')}}" title="Linhas de pesquisa" class="destination">Linhas de pesquisa</a>
                            <ul class="tier-2">
                                ...
                                <li class=""> <a href="{{url('/linhasdepesquisa/rTMS')}}" title="TMS" class="destination">TMS</a> </li>
                                ...
                                <li class=""> <a href="{{url('/linhasdepesquisa/Genética')}}" title="Genética" class="destination">Genética</a> </li>
