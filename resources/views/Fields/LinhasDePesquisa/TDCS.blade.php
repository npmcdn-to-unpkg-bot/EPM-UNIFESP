...
@section('block')
    <div class="block" data-block-id="8015">
        ...
        <h2 class="head">tDCS – Estimulação transcraniana por corrente contínua</h2>
        ...
        <p>
            <br><br>Técnica de estimulação cerebral que utiliza corrente de baixa intensidade, ministrada por eletrodos dispostos sobre o escalpo, para induzir efeitos plásticos no cérebro, associados à melhora de uma série de sintomas psiquiátricos e neurológicos, bem como ao aumento da performance cognitiva. Centenas de ensaios clínicos e diversas meta-análises confirmam a sua eficácia.
