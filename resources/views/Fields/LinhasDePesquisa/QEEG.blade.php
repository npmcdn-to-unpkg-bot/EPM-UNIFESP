...
@section('block')
    <div class="block" data-block-id="8015">
        ...
        <p><blockquote>Figura 1.Imagem de estudo que comparou a habilidade de identificação de áreas epileptogênicas através de Loreta com ressonância magnética pós-operativa. A conclusão foi que Loreta é eficiente na identificação destes focos [1].</p>
        <ol>
