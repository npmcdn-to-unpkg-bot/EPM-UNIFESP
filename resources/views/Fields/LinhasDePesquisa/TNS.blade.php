...
@section('block')
    <div class="block" data-block-id="8015">
        ...
        <h2 class="head">TNS – Estimulação do nervo trigêmeo</h2>
        ...
        <p>
            ...
            <br><br>Especula-se que este trajeto bottom-up seja mais eficiente na produção de efeitos modulatórios em áreas subcorticais envolvidas em diversos transtornos psiquiátricos e doenças neurológicas, o que pode contribuir para os efeitos terapêuticos da técnica.
        </p>
        <br>
